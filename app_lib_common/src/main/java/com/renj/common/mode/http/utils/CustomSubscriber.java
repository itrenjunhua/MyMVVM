...
import com.renj.mvvmbase.view.IBaseView;
...
public abstract class CustomSubscriber<T> extends ResourceSubscriber<T> {
    ...
    @LoadingStyle
    int loadingStyle;
    private BaseLoadViewModel mBaseLoadViewModel;

    public CustomSubscriber(@LoadingStyle int loadingStyle, @NonNull BaseLoadViewModel baseLoadViewModel) {
        this.loadingStyle = loadingStyle;
        this.mBaseLoadViewModel = baseLoadViewModel;
    }

    @Override
    public void onNext(T t) {
        onResult(t);
        mBaseLoadViewModel.pageStatusData.setValue(new PageStatusData(RPageStatus.CONTENT, loadingStyle, t));
    }
    ...
    public void onError(Throwable e) {
        ...
        if (e instanceof NetworkException) {
            mBaseLoadViewModel.pageStatusData.setValue(new PageStatusData(RPageStatus.NET_WORK, loadingStyle));
         ...
         */
            ...
            mBaseLoadViewModel.pageStatusData.setValue(new PageStatusData(RPageStatus.EMPTY, loadingStyle, nullDataException.getBaseResponseBean()));
            ...
            mBaseLoadViewModel.pageStatusData.setValue(new PageStatusData(RPageStatus.ERROR, loadingStyle, e));
