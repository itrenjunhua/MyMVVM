...
import com.renj.home.databinding.CellGeneralListBinding;
 ...
 * ======================================================================
 */
public class GeneralListCell extends BindingRecyclerCell<GeneralListBean, CellGeneralListBinding> {
    ...
    public BindingRecyclerViewHolder onCreateViewHolder(@NonNull Context context, @NonNull ViewGroup parent, int viewType) {
        return new BindingRecyclerViewHolder(context, parent, R.layout.cell_general_list);
    }

    @Override
    public void onBindViewHolder(@NonNull BindingRecyclerViewHolder holder, CellGeneralListBinding viewDataBinding, int position, GeneralListBean itemData) {
    ...
    public void onItemClick(@NonNull Context context, @NonNull BindingRecyclerAdapter recyclerAdapter,
                            @NonNull BindingRecyclerViewHolder holder, CellGeneralListBinding viewDataBinding,
